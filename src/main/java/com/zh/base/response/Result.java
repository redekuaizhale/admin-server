...
import com.zh.constants.ResultConstant;
import lombok.Data;
...
public class Result {
    ...
    public static Result newSuccessResult(String resultMessage) {
        ...
        result.setResultCode(ResultConstant.SUCCESS_CODE.getValue());
    ...
    public static Result newErrorResult(String resultMessage) {
        Result result = new Result();
        result.setResultCode(ResultConstant.ERROR_CODE.getValue());
        result.setResultMessage(resultMessage);
        return result;
    }
}
